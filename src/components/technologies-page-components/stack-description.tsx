...
const stackCards: ICard[] = [
  ...
  {
    title: 'TypeScript',
    content: ` Since JavaScript is a dynamically typed programming language and is not type-safe, TypeScript was used to
  ...
  {
    title: 'MUI',
    content: ` MUI is a UI library built specifically for React. It provides a set of ready-made components and utilities
              that help to build a consistent and accessible UI. It is a great choice for building responsive and
              adaptive interfaces as fast as possible, and MUI X adds advanced components for admin panels and dashboards.`,
    rowDirection: rowDirection.ROW,
    icon: <SiMui size={32} />,
  },
  {
    title: 'React Router',
    content: ` Since React is just a library, not a complete framework, React Router brings routing to React projects. It
              ...
              rendered inside it via an Outlet component instead of being manually nested in the layout component.`,
    rowDirection: rowDirection.ROW,
    icon: <SiReactrouter size={32} />,
  },
  {
    title: 'Vite',
    content: ` Vite is the build tool and dev server. It gives very fast hot reloads while developing and produces an
              optimized bundle for production, so the portfolio loads quickly even with media-heavy pages. It also ships
              with ready-to-use ESLint and TypeScript configs for the project template.`,
    rowDirection: rowDirection.ROW,
    icon: <SiVite size={32} />,
  },
];
